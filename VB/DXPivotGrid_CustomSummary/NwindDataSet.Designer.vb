...
Namespace DXPivotGrid_CustomSummary
	...
	Partial Public Class DataSet1
		...
		Partial Public Class OrderReportsDataTable
			...
			<Global.System.Diagnostics.DebuggerNonUserCodeAttribute(), Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")> _
			Public Function AddOrderReportsRow(ByVal ProductName As String, ByVal Extended_Price As Decimal) As OrderReportsRow
				Dim rowOrderReportsRow As OrderReportsRow = (CType(Me.NewRow(), OrderReportsRow))
				Dim columnValuesArray() As Object = { ProductName, Extended_Price}
...
Namespace DXPivotGrid_CustomSummary.DataSet1TableAdapters
	...
	Partial Public Class OrderReportsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT ProductName, [Extended Price] FROM OrderReports"
